    ...
    return Column(
      children: [
        ...
        Padding(
            ...
            child: Row(
              mainAxisAlignment:
                  MainAxisAlignment.spaceBetween, // ← Ajoutez cette ligne
              children: [
                Flexible(
                  // ← Enveloppez les Text/TextButton dans Flexible
                  child: Text(
                    "© 2025 Gérard DUCROCQ tous droits réservés",
                    style: textStyleText(context),
                    overflow: TextOverflow
                        .ellipsis, // ← Optionnel pour éviter les débordements
                  ),
                ),
                Flexible(
                  child: TextButton(
                      onPressed: () async {
                        final Uri url =
                            Uri.parse('https://ludovicspysschaert.fr/');
                ...
                SizedBox(
                    ...
                    child: PopupMenuButton<String>(
                      icon: Icon(Icons.info_outline,
                          color: Colors.black), // Icône noire visible
